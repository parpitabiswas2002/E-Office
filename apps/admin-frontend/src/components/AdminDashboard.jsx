...
const generateMockData = () => {
  ...
  const statuses = ['Active', 'Active', 'Active', 'Past Due'];
...
export default function AdminDashboard({ authenticatedUser, onSignOut }) {
        ...
        <div className="p-4 border-t border-gray-200">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-full bg-indigo-100 flex items-center justify-center text-indigo-700 font-bold">
              {(authenticatedUser || 'A').charAt(0).toUpperCase()}
            </div>
            <div className="text-sm flex-1 min-w-0">
              <p className="font-medium truncate">{authenticatedUser || 'Admin User'}</p>
              <button onClick={onSignOut} className="text-red-500 hover:text-red-600 text-xs flex items-center gap-1 transition-colors">
        ...
        <div className="fixed inset-0 z-40 md:hidden">
          ...
          <aside className="fixed left-0 top-0 bottom-0 w-64 bg-white z-50 flex flex-col shadow-xl">
            <div className="h-16 flex items-center justify-between px-6 border-b border-gray-200">
              ...
              <button onClick={() => setMobileMenuOpen(false)}><X className="w-5 h-5 text-gray-500" /></button>
            </div>
            <nav className="flex-1 px-4 py-6 space-y-1">
            ...
            <div className="p-4 border-t border-gray-200">
              <button onClick={onSignOut} className="text-red-500 hover:text-red-600 text-sm flex items-center gap-1">
              ...
              <table className="min-w-full divide-y divide-gray-200">
                <thead className="bg-gray-50">
                  <tr>
                    ...
                    <th scope="col" className="px-6 py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Plan & Price</th>
                    <th scope="col" className="px-6 py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Usages</th>
                    <th scope="col" className="px-6 py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Status</th>
                    <th scope="col" className="px-6 py-4 text-center text-xs font-semibold text-gray-500 uppercase tracking-wider">Disable Account</th>
                  </tr>
                </thead>
